...
if parentGui:FindFirstChild("GuestHubScreenGui") then
    parentGui.GuestHubScreenGui:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "GuestHubScreenGui"
...
AddButton(settingsPage, "Unload UI", "Completely unhooks script and unloads from memory", function()
    Notify("GuestHub", "Unloading and unhooking...", 1)
    task.wait(0.3)
...
Notify("GuestHub", "Successfully loaded. Press RightShift to toggle.", 3)